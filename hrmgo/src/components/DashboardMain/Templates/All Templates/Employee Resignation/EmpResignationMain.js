...
const EmpResignationMain = () => {
  ...
  useEffect(() => {
    const fetchNewUserContent = async () => {
      try {
        const response = await getAPI("/get-employee-resignation-content");
        const mappedData = {
          // mail_from_name: response.data.mailFromName || "",
          subject: response.data.subject || "Employee Resignation",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await postAPI("/employee-resignation-content", formData);
              ...
              <div className="card mb-0 h-100">
                <div className="card-header card-body">
                  ...
                  <div className="row">
                    ...
                    <p className="col-6">
                      Employee Name:{" "}
                      <span className="text-primary">{`{assign_user}`}</span>
                    </p>
                    <p className="col-6">
                      Last Working Date:{" "}
                      <span className="text-primary">{`{resignation_date}`}</span>
                    </p>
                    <p className="col-6">
                      Resignation Date:{" "}
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="form-group col-12">
                        ...
                        <input
                          ...
                          name="subject"
                          type="text"
                          defaultValue="Employee Resignation"
                          id="subject"
                        />
                      </div>
                      <div className="form-group col-12">
...
export default EmpResignationMain;
