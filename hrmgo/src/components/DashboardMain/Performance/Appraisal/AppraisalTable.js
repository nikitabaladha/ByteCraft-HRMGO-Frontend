                    ...
                    <tbody>
                      {paginatedAppraisals.length > 0 ? (
                        paginatedAppraisals.map((appraisal) => (
                          <tr key={appraisal.id}>
                            <td className="text-dark">{appraisal.branch}</td>
                            <td className="text-dark">{appraisal.department}</td>
                            <td className="text-dark">{appraisal.designation}</td>
                            <td className="text-dark">{appraisal.employee}</td>
                            <td className="text-dark">{renderStars(appraisal.targetRating)}</td>
                            <td className="text-dark">{renderStars(appraisal.overAllRating)}</td>
                            <td className="text-dark">{formatDate(appraisal.createdAt)}</td>
                            <td className="Action">
