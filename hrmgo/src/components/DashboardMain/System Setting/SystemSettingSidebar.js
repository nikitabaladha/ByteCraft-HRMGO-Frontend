...
import EmailSettings from "./Email Setting/EmailSettng";
import EmailNotificationSetting from "./Email Notification Setting/EmailNotificationSetting";
...
const Sidebar = () => {
  ...
  const menuItems = useMemo(
    () => [
      ...
      { id: "emailNotificationSetting", label: "Email Notification Settings" },
    ],
    []
  );
  ...
  return (
    <div className="row">
      ...
      <div className="col-xl-9">
        ...
        <div id="emailNotificationSetting">
