...
function ConfirmationDialog({ onClose, transferBalanceId, onDeleted, deleteType }) {
  const handleDelete = async () => {
    try {
      if (!transferBalanceId) {
        console.error("Transfer Balance ID is missing.");
        toast.error("Transfer Balance ID is required.");
        return;
      }
