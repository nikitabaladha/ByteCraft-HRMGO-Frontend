...
const TransferBalanceTable = ({
  ...
  const filteredTransferBalances = transferBalances.filter(
    (transferBalance) => {
      const searchTerm = searchQuery.toLowerCase();
      const formattedDate = new Date(transferBalance.date)
                            ...
                            <div className="dt-buttons">
                              <span>
                                ...
                                <div className="action-btn bg-danger">
                                  <button
                                    onClick={() =>
                                      openDeleteDialog(transferBalance._id)
                                    }
                                    type="submit"
                                    className="mx-3 btn btn-sm align-items-center"
              ...
              <nav className="dataTable-pagination">
                <ul className="dataTable-pagination-list">
                  ...
                  {Array.from(
                    {
                      length: Math.ceil(
                        transferBalances.length / entriesPerPage
                      ),
                    },
                    (_, index) => (
                      <li
                  ...
                  {currentPage <
                    Math.ceil(transferBalances.length / entriesPerPage) && (
                    <li className="page-item">
                      <button
