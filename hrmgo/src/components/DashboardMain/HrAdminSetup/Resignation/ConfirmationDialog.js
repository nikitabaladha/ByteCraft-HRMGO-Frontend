...
function ConfirmationDialog({ onCancel, resignation }) {
  const handleDelete = async () => {
    try {
      ...
      if (!response.hasError) {
        ...
        toast.success("Resignation successfully deleted!");
      } else {
        console.error("Error deleting Resignation:", response.message);
        toast.error(`Failed to delete Resignation: ${response.message}`);
      }
    } catch (error) {
