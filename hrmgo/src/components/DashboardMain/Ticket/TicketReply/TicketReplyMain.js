...
const TicketReply = () => {
  ...
  const descriptionWithoutHtml = ticket
  ...
  useEffect(() => {
    const fetchTicketReplies = async () => {
      try {
        const repliesResponse = await getAPI(
                      ...
                      <div className="card-body">
                        ...
                        >
                          ...
                          <div className="text-end">
                            <button
                              type="submit"
                              className="btn btn-sm bg-primary w-100"
                              style={{ color: "white" }}
                            >
                              <i className="ti ti-circle-plus me-1 mb-0"></i>{" "}
                              Send
                            </button>
                          </div>
                        </form>
                    ...
                    replies.map((reply, index) => (
                      <div key={reply._id || index} className="card border">
                        <div className="card-header row d-flex align-items-center justify-content-between">
                          ...
                          <p className="col-auto ms-1 mb-0">
                            {" "}
                            <span className="text-muted">
                        ...
                        <div className="p-4">
                          <p>
                            {reply.description
                              ? removeHtmlTags(reply.description)
