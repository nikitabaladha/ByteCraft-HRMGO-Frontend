...
const CreateJobStageModal = ({ closeModal }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!name) {
      toast.error("Job stage name is required.");
      return;
    }
    ...
    try {
      const response = await postAPI("/create-job-stage", jobStageData, true);
      ...
      toast.error("An error occurred while creating the job stage.");
    }
  };
      ...
      <div className="modal-dialog modal-undefined" role="document">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title" id="exampleModalLabel">Create New Job Stage</h5>
...
export default CreateJobStageModal;
