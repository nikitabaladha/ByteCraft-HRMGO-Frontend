...
const CreateIncomeTypeModal = ({ closeModal }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await postAPI("/create-income-type", incomeTypeData, true);
      ...
      toast.error("An error occurred while creating the income type.");
    }
  };
      ...
      <div className="modal-dialog modal-undefined" role="document">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title" id="exampleModalLabel">Create New Income Type</h5>
