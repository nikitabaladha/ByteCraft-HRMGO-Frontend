...
const CreateContractTypeModal = ({ closeModal }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await postAPI("/create-contract-type", contractTypeData, true);
      ...
      toast.error("An error occurred while creating the contract type.");
    }
  };
      ...
      <div className="modal-dialog modal-undefined" role="document">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title" id="exampleModalLabel">Create New Contract Type</h5>
...
export default CreateContractTypeModal;
