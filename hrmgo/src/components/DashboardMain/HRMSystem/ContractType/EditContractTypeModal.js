...
const EditContractTypeModal = ({ closeModal, contractType }) => {
    ...
    useEffect(() => {
        if (contractType) {
            setName(contractType.contractName); 
        }
    }, [contractType]);
    ...
    const handleSubmit = async (e) => {
        ...
        if (!contractType?._id) {
            toast.error("Invalid contract type details.");
            return;
        }
        ...
        try {
            ...
            toast.error("An error occurred while updating the contract type.");
        }
    };
            ...
            <div className="modal-dialog modal-undefined" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title" id="exampleModalLabel">Edit Contract Type</h5>
