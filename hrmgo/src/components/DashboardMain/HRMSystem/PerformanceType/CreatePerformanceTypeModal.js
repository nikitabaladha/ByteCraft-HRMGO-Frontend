...
const CreatePerformanceTypeModal = ({ closeModal }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!name) {
      toast.error("Performance type name is required.");
      return;
    }
    ...
    try {
      const response = await postAPI("/create-performance-type", performanceTypeData, true);
      ...
      toast.error("An error occurred while creating the performance type.");
    }
  };
      ...
      <div className="modal-dialog modal-undefined" role="document">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title" id="exampleModalLabel">Create New Performance Type</h5>
...
export default CreatePerformanceTypeModal;
