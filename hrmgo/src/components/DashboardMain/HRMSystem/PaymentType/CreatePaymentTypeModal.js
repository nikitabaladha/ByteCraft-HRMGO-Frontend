...
const CreatePaymentTypeModal = ({ closeModal }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await postAPI("/create-payment-type", paymentTypeData, true);
      ...
      toast.error("An error occurred while creating the payment type.");
    }
  };
      ...
      <div className="modal-dialog modal-undefined" role="document">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title" id="exampleModalLabel">Create New Payment Type</h5>
