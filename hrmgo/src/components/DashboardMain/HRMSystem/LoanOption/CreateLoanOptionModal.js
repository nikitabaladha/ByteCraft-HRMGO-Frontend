...
const CreateLoanOptionModal = ({ closeModal }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await postAPI('/loan-option', loanOptionData, true);
            ...
            toast.error("An error occurred while creating the loan option.");
        }
    };
            ...
            <div className="modal-dialog modal-undefined" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title" id="exampleModalLabel">Create New Loan Option</h5>
...
export default CreateLoanOptionModal;
