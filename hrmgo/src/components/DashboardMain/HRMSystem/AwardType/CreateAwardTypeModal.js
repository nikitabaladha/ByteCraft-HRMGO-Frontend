...
const CreateAwardTypeModal = ({ closeModal }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!name) {
      toast.error("Award type name is required.");
      return;
    }
    ...
    try {
      const response = await postAPI("/create-award-type", awardTypeData, true);
      ...
      toast.error("An error occurred while creating the award type.");
    }
  };
      ...
      <div className="modal-dialog modal-undefined" role="document">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title" id="exampleModalLabel">Create New Award Type</h5>
...
export default CreateAwardTypeModal;
