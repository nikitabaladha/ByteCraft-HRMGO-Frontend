...
const CreatePayslipModal = ({ closeModal }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await postAPI('/payslip-type', payslipData, true);
            ...
            toast.error("An error occurred while creating the payslip.");
        }
    };
            ...
            <div className="modal-dialog modal-undefined" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title" id="exampleModalLabel">Create New Payslip</h5>
