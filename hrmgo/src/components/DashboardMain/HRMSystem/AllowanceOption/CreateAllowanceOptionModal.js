...
const CreateAllowanceOptionModal = ({ closeModal }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await postAPI('/allowance-option', allowanceOptionData, true);
            ...
            toast.error("An error occurred while creating the allowance option.");
        }
    };
            ...
            <div className="modal-dialog modal-undefined" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title" id="exampleModalLabel">Create New Allowance Option</h5>
...
export default CreateAllowanceOptionModal;
