...
const AllowanceOptionTable = ({
  ...
  const filteredAllowanceOptions = allowanceOptions.filter(
    (allowanceOption) => {
                    ...
                    <tbody>
                      {paginatedAllowanceOptions.map((allowanceOption) => (
                        <tr key={allowanceOption._id}>
                          <td className="text-dark">{allowanceOption.allowanceName}</td>
                          <td className="Action">
                              ...
                              <span>
                                ...
                                <div className="action-btn bg-danger">
                                  ...
                                  >
                                    ...
                                    <Link
                                      onClick={() =>
                                        openDeleteDialog(allowanceOption._id)
                                      }
              ...
              <nav className="dataTable-pagination">
                <ul className="dataTable-pagination-list">
                  ...
                  {Array.from(
                    {
                      length: Math.ceil(
                        allowanceOptions.length / entriesPerPage
                      ),
                    },
                    (_, index) => (
                      <li
                  ...
                  {currentPage <
                    Math.ceil(allowanceOptions.length / entriesPerPage) && (
                    <li className="page-item">
                      <button
