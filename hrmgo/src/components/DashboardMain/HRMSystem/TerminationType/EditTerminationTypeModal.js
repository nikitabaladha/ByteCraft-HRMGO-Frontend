...
const EditTerminationTypeModal = ({ closeModal, terminationType }) => {
    ...
    useEffect(() => {
        if (terminationType) {
            setName(terminationType.terminationName);
        }
    }, [terminationType]);
    ...
    const handleSubmit = async (e) => {
        ...
        if (!terminationType?._id) {
            toast.error("Invalid termination type details.");
            return;
        }
        ...
        try {
            const response = await putAPI(`/update-termination-type/${terminationType._id}`, terminationTypeData, true);
            ...
            toast.error("An error occurred while updating the termination type.");
        }
    };
            ...
            <div className="modal-dialog modal-undefined" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title" id="exampleModalLabel">Edit Termination Type</h5>
...
export default EditTerminationTypeModal;
