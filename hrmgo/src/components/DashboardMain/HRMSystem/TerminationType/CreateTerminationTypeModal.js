...
const CreateTerminationTypeModal = ({ closeModal }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!name) {
      toast.error("Termination type name is required.");
      return;
    }
    ...
    try {
      ...
      toast.error("An error occurred while creating the termination type.");
    }
  };
...
export default CreateTerminationTypeModal;
