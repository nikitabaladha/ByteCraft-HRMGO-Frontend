...
function ConfirmationDialog({ onClose, meetingId, onDeleted, deleteType }) {
  const handleDelete = async () => {
    ...
    try {
      ...
      if (deleteType === "meeting") {
        endpoint = `/delete_zoommeeting/${meetingId}`; // Updated endpoint for meeting
      ...
      if (!response.hasError) {
        ...
        if (typeof onDeleted === "function") {
          onDeleted(meetingId); // Call the onDeleted callback with meetingId
        }
