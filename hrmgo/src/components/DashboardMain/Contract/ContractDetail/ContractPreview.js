...
//       `${window.location.origin}/storage/uploads/logo/Black-Logo (1).png`
//     );

//     // At time of download word file i want same html structure just like below  id="printTable"
//     const htmlContent = `
//       <html>
//         <head>
//           <meta charset="utf-8">
...
//                 {/* what ever the html structure below is i want same it in above htmlContent  */}
      ...
      <html>
        <head>
          ...
          <style>
            ...
            h2 { color: #333; }
            p { line-height: 1.5; }
            .invoice-title { display: flex; justify-content: space-between; align-items: center; }
            .invoice-number { margin: 0; }
