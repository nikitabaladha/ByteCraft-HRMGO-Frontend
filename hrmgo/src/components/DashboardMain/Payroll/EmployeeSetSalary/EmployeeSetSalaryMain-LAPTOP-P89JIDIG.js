...
//     const { _id } = useParams(); // Extract the id from the route
//     const [employee, setEmployee] = useState(null);

//     useEffect(() => {
//         const fetchEmployee = async () => {
//             try {
//                 const response = await getAPI(`/SetSalary-get-all/${_id}`, {}, true); 
//                 console.log('Employee Set Salary', response.data.data) // Adjust endpoint
...
//                                 <div className="project-amnt pt-1">{employee.payrollType}</div>
//                             </div>
//                             <div className="project-info-inner mr-3 col-1">
//                                 <b className="m-0">Salary</b>
//                                 <div className="project-amnt pt-1">{employee.salary}</div>
//                             </div>
//                         </div>
//                         <div className="project-info d-flex text-sm">
