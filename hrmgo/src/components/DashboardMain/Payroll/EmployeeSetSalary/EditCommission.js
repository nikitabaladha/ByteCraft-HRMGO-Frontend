...
const UpdateCommissionModal = ({ onClose, commissionData, employee }) => {
    ...
    useEffect(() => {
        if (commissionData) {
            ...
            setTitle(commissionData.title);
            setType(commissionData.type);
            setAmount(commissionData.amount);
        }
    }, [commissionData]);
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title" id="exampleModalLabel">Edit Commission</h5>
