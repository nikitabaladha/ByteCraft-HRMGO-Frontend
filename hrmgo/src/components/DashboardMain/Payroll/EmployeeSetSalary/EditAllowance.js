...
const UpdateAllowanceModal = ({ onClose, allowanceData, employee}) => {
    ...
    useEffect(() => {
        if (allowanceData) {
            ...
            setAllowanceOption(allowanceData.allowanceOption);
            setTitle(allowanceData.title);
            setType(allowanceData.type);
            setAmount(allowanceData.amount);
        }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.error('Error occurred while updating allowance.');
        }
    };
...
export default UpdateAllowanceModal;
